        ...
        <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none select-none">
            ...
            <div className="absolute inset-0 z-0 [perspective:1000px]">
                ...
                <div className="absolute inset-0 origin-bottom transform-gpu rotate-x-[60deg]">
                    ...
                    <div className="w-[400%] h-[400%] -ml-[150%] -mt-[50%] bg-[linear-gradient(to_right,rgba(6,182,212,0.3)_1px,transparent_1px),linear-gradient(to_bottom,rgba(6,182,212,0.3)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:linear-gradient(to_bottom,transparent_5%,white_100%)] animate-grid-flow" />
                </div>
            </div>
        </div>
    );
